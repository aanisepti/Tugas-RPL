...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">SEP.BOXVII</span></h1>
          <hr>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Sep.</strong> boxvii</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">SEP.BOXVII</h3>
          <h5>Jln.Basuki Rahmat Praya
          <br>Buka Jam <strong>13:00 - 22:00</strong></h5>
        </div>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2022 -  Designed by SEPTIANI</p>
          </div>
          </div>
